        ...
        <div class="col-lg-8 col-md-8 col-12">
          ...
          <?php endwhile; ?>
            <?php the_posts_pagination( array(
              'prev_text' => __( 'Previous page', 'delight-bakery' ),
              'next_text' => __( 'Next page', 'delight-bakery' ),
              'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'delight-bakery' ) . ' </span>',
            ) ); ?>
          <?php else : ?>
